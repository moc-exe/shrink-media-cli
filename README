## The humble idea and the 3 milestones

This project is solving my annoyance at the data upload limits I currently have to face when using
matrix.org homeserver to talk to my friends. With their free plan, I can only upload 500mb per 28 days and 100mb per 24 hours. 

Upload being scarce, and me being unwilling (for now) to get a paid plan, this project is a quick utility tool to compress common media formats directly from your terminal. 
